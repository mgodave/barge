...
class StateMachineProxy {
  ...
  @Nonnull
  public ListenableFuture dispatchOperation(final long index, @Nonnull final ByteBuffer op, final Map<Long, SettableFuture<Object>> listeners) {
